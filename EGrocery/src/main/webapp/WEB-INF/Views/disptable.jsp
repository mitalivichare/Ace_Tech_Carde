...
<tbody>
	<c:if test="${pid=='1' }">
	<tr ng-repeat="product in Data|filter:{category:'Fruits'}|filter:search">
	...
	<c:if test="${pid=='2' }">
	<tr ng-repeat="product in Data|filter:{category:'Beverages'}|filter:search">
	<td><img alt="NO IMAGE" height="50px" width="50px" src="<c:url value='/resources/{{product.category}}/{{product.image}}'/>" /></td>
 		<td>{{product.name}}</td>
		<td>{{product.price}}</td>
		<td>{{product.qty}}</td>
	...
	<c:if test="${pid=='3' }">
	<tr ng-repeat="product in Data|filter:{category:'Dairyproducts'}|filter:search">
	<td><img alt="NO IMAGE" height="50px" width="50px" src="<c:url value='/resources/{{product.category}}/{{product.image}}'/>" /></td>
 		<td>{{product.name}}</td>
		<td>{{product.price}}</td>
		<td>{{product.qty}}</td>
